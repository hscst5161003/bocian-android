...
public class EditCompanyListAdapter extends BaseAdapter {    // 自作のadapterを作成する

    public static final int ZERO = 0;

    private int resource;
    private Context context;
    private List<EditCompanyListItem> data;

    public EditCompanyListAdapter(Context context, List<EditCompanyListItem> data, int resource) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        EditCompanyListItem item = (EditCompanyListItem) getItem(position);
