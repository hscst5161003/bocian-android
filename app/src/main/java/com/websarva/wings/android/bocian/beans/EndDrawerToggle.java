...
public class EndDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    @Override
    public void onDrawerSlide(View drawerView, float slideOffset) {     // slideOffsetには、ドロワーが動いた距離の比率が0~1
        setPosition(Math.min(1f, Math.max(0, slideOffset)));
    }

    @Override
    public void onDrawerOpened(View drawerView) { setPosition(1f); }

    @Override
    public void onDrawerClosed(View drawerView) { setPosition(0f); }
